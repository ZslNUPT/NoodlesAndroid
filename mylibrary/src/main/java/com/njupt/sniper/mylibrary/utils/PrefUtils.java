package com.njupt.sniper.mylibrary.utils;
...
public final class PrefUtils {
    private static final String OBJECT = "saveObject";
    ...
    public static void setObject(Context context, String key, Object obj) {
        try {
            // 保存对象
            SharedPreferences.Editor sharedata = context.getSharedPreferences("saveObject", 0).edit();
    ...
    public static Object getObject(Context context, String key) {
        try {
            SharedPreferences sharedata = context.getSharedPreferences(OBJECT, 0);
